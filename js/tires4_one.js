...
document.getElementById('tire4_one').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_direction/23')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table15').innerHTML = output;
            document.getElementById('average13').innerHTML = average13;
        });
