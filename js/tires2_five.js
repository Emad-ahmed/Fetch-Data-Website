...
document.getElementById('tire2_five').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/temperature/719')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table7').innerHTML = output;
            document.getElementById('average5').innerHTML = average5;
