...
document.getElementById('tire5_one').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/rain/23')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table21').innerHTML = output;
            document.getElementById('average19').innerHTML = average19;
        });
