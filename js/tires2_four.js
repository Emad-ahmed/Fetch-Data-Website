...
document.getElementById('tire2_four').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/temperature/167')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table6').innerHTML = output;
            document.getElementById('average4').innerHTML = average4;
