...
document.getElementById('tire4_two').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_direction/47')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table16').innerHTML = output;
            document.getElementById('average14').innerHTML = average14;
        });
