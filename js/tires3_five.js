...
document.getElementById('tire3_five').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_speed/719')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table13').innerHTML = output;
            document.getElementById('average11').innerHTML = average11;
        });
