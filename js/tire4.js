...
document.getElementById('tire4').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_direction')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table14').innerHTML = output;
            document.getElementById('average12').innerHTML = average12;
        });
