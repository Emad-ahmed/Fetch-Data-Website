...
document.getElementById('tire2_one').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/temperature/23')
        ...
        `<tr>
            ...
            document.getElementById('table3').innerHTML = output;
            document.getElementById('average1').innerHTML = average1;
