...
document.getElementById('tire6_one').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/light/23')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table27').innerHTML = output;
            document.getElementById('average25').innerHTML = average25;
        });
