...
document.getElementById('tire5').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/rain')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table20').innerHTML = output;
            document.getElementById('average18').innerHTML = average18;
        });
