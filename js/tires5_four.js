...
document.getElementById('tire5_four').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/rain/167')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table24').innerHTML = output;
            document.getElementById('average22').innerHTML =average22;
        });
