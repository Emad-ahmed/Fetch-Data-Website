...
document.getElementById('tire3_three').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_speed/71')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table11').innerHTML = output;
            document.getElementById('average9').innerHTML = average9;
        });
            // new request..
