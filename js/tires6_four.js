...
document.getElementById('tire6_four').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/light/167')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table30').innerHTML = output;
            document.getElementById('average28').innerHTML = average28;
        });
