...
document.getElementById('tire6_five').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/light/719')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table31').innerHTML = output;
            document.getElementById('average29').innerHTML = average29;
        });
