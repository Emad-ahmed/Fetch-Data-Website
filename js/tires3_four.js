...
document.getElementById('tire3_four').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_speed/167')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table12').innerHTML = output;
            document.getElementById('average10').innerHTML = average10;
        });
            // new request..
