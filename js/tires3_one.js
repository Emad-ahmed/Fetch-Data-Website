...
document.getElementById('tire3_one').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_speed/23')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table9').innerHTML = output;
            document.getElementById('average7').innerHTML = average7;
        });
