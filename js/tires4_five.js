...
document.getElementById('tire4_five').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_direction/719')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table19').innerHTML = output;
            document.getElementById('average17').innerHTML = average17;
        });
