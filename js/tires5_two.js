...
document.getElementById('tire5_two').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/rain/47')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table22').innerHTML = output;
            document.getElementById('average20').innerHTML = average20;
        });
