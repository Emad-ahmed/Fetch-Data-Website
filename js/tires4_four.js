...
document.getElementById('tire4_four').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/wind_direction/167')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table18').innerHTML = output;
            document.getElementById('average16').innerHTML = average16;
        });
