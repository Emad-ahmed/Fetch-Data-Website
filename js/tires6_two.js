...
document.getElementById('tire6_two').addEventListener('click', latest_data);
...
function latest_data() {
    fetch('http://webapi19sa-1.course.tamk.cloud/v1/weather/light/47')
        ...
        <th class="table-active">Row Number</th>
            ...
            document.getElementById('table28').innerHTML = output;
            document.getElementById('average26').innerHTML = average26;
        });
